import{_ as a,o as i,c as n,a0 as p}from"./chunks/framework.Dr4t-sxF.js";const c=JSON.parse('{"title":"API","description":"","frontmatter":{},"headers":[],"relativePath":"api.md","filePath":"api.md"}'),e={name:"api.md"};function t(l,s,h,k,r,o){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h1><h2 id="import-meta-env-babel" tabindex="-1">@import-meta-env/babel <a class="header-anchor" href="#import-meta-env-babel" aria-label="Permalink to &quot;@import-meta-env/babel&quot;">​</a></h2><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> PluginOptions</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span>                          avoid rebuilding the project when environment</span></span>
<span class="line"><span>                          variable changes, In production, enable this option</span></span>
<span class="line"><span>                          to avoid generating unnecessary backup files.</span></span>
